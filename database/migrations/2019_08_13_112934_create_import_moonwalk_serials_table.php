...
class CreateImportMoonwalkSerialsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('import_moonwalk_serials', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('import_moonwalk_serials');
    }
}
