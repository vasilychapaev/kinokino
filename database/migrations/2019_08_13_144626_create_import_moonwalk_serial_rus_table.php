...
class CreateImportMoonwalkSerialRusTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('import_moonwalk_serials_rus', function (Blueprint $table) {
            ...
            $table->integer('seasons_count')->unsigned()->nullable();
            $table->integer('episodes_count')->unsigned()->nullable();
            $table->text('season_episodes_count')->nullable();
    ...
    {
        Schema::dropIfExists('import_moonwalk_serials_rus');
    }
}
