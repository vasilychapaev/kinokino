...
class CreateImportMoonwalkRussiansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('import_moonwalk_russians', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('import_moonwalk_russians');
    }
}
